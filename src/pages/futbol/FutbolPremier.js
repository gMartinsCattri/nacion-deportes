...
const Americano = () => {
  ...
  const [teamId, setTeamId] = useState(20)
  const [teamIdArray, setTeamIdArray] = useState(2)
    
    useEffect(() => {
        fetch(`https://alfred.to/reservas/spreadsheets/futbol/liga_premiere`, {
          headers: new Headers({
...
<Header></Header>
  <div style={{width: '100%', height: '96%', backgroundColor: 'white'}}>
   <div style={{display:'flex', justifyContent:'center'}}> <img style={{width: '800px', marginBottom:'120px'}} src="https://alfred.to/media/cc_uat/app_deportes/premier_league/premiere_league_titulo.png" alt="" /></div>
